...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-marketing-agent?sort=semver)](https://github.com/liberusoftware/module-crm-marketing-agent/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-marketing-agent/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-marketing-agent/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-marketing-agent
```
...
<a href="https://github.com/liberusoftware/module-crm-marketing-agent/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-marketing-agent" alt="Contributors to liberusoftware/module-crm-marketing-agent">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-marketing-agent/graphs/contributors).
